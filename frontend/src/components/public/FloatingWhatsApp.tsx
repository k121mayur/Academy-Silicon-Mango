...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white shadow-card-hover px-5 py-3.5 transition-transform duration-200 ease-out hover:scale-105 active:scale-95"
    >
      <svg
        viewBox="0 0 24 24"
        width={24}
      ...
      <span className="hidden sm:inline font-semibold text-body-sm">Chat with us</span>
    </a>
  );
}
